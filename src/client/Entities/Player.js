import {MAX_BOMB, MAX_POWER, MAX_SPEED, PlayerConfig/*, PlayerDirection*/} from "../Constants";
...
export class Player extends Phaser.GameObjects.Container {
    ...
    constructor(scene, x = 0, y = 0, playerInfo = {id: null, playerNumber: null}, isNPC = false) {
        super(scene, x, y);
    ...
    createCursor() {
        let keys = PlayerConfig[this.playerNumber].keys;
    ...
    //        x: x,
    //        duration: 500,
    //        onComplete: tween => this.playerSprite.anims.stop(),
    //    });
    //}
    ...
    updateMovement() {
        ...
        //if (Date.now() - this.lastMoveUpdate < 200) {
